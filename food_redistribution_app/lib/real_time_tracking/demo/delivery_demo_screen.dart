...
class DeliveryDemoScreen extends StatefulWidget {
  const DeliveryDemoScreen({Key? key}) : super(key: key);
...
class _DeliveryDemoScreenState extends State<DeliveryDemoScreen> {
  ...
  void initState() {
    ...
    _delay = DelayDetectionService(pickupThreshold: Duration(seconds: 10), deliveryThreshold: Duration(seconds: 20));
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            Text('Demo Delivery ID: $demoId', style: Theme.of(context).textTheme.titleLarge),
