...
class _CreateDonationScreenState extends State<CreateDonationScreen> {
  ...
  void _useCurrentLocationAsPickup() {
    if (_currentLat == null || _currentLng == null) {
      _showErrorSnackBar('Current location is not available yet');
      return;
    }
  ...
  Future<void> _createDonation() async {
    ...
    if (pickupAddress.isNotEmpty) {
      final geocoded = await _locationService.geocodeAddress(pickupAddress);
      if (geocoded == null) {
        _showErrorSnackBar(
            'Unable to locate the pickup address. Please enter a more specific address.');
        return;
      }

      _currentLat = (geocoded['latitude'] as num?)?.toDouble();
      _currentLng = (geocoded['longitude'] as num?)?.toDouble();
    }
    ...
    if (_currentLat == null ||
      ...
      _showErrorSnackBar(
          'Valid pickup location is required for automatic matching');
      return;
    }
    ...
    final pickupLocation = _locationService.buildLocationData(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomTextField(
                      ...
                      hintText:
                          'Full address or coordinates like 11.010664, 76.964565',
                      maxLines: 2,
                      validator: (value) {
                        if (value == null || value.isEmpty) {
