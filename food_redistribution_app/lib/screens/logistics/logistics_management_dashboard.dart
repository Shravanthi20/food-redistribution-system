...
class _LogisticsManagementDashboardState extends State<LogisticsManagementDashboard> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Logistics Management', style: TextStyle(fontWeight: FontWeight.bold)),
  ...
  Widget _buildDeliveryTrendsChart() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Delivery Trends', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          Expanded(
            child: LineChart(
              LineChartData(
                ...
                lineBarsData: [
                  LineChartBarData(
                    spots: [
                      const FlSpot(0, 3), const FlSpot(1, 4), const FlSpot(2, 6), const FlSpot(3, 5),
                      const FlSpot(4, 7), const FlSpot(5, 8), const FlSpot(6, 6), const FlSpot(7, 9),
                    ],
                    isCurved: true,
                    color: Colors.blue,
                    barWidth: 3,
  ...
  Widget _buildVolunteerDistributionChart() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Volunteer Status', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          Expanded(
            child: PieChart(
              PieChartData(
  ...
  Widget _buildRouteEfficiencyChart() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Route Efficiency', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          Expanded(
            child: BarChart(
              BarChartData(
  ...
  Widget _buildFoodTypeDistributionChart() {
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const Text('Food Type Distribution', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
          const SizedBox(height: 16),
          Expanded(
            child: Row(
              children: [
