...
void main() {
  group('Welcome Screen Widget Tests', () {
    ...
    testWidgets('should display role descriptions',
      ...
      expect(
          find.text('Share surplus food with those in need'), findsOneWidget);
      expect(
          find.text('Connect with donors to help communities'), findsOneWidget);
      ...
      expect(
          find.text('Help with food collection and delivery'), findsOneWidget);
    });
